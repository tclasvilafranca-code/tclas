...
"""Portada, índice, plan de curso y álbum completo del cuaderno de Eduard.
   ...
   Formato ADULTO (seis hojas por pieza), el mismo repertorio y el mismo
   orden que José María — el cliente lo pidió así: "el mismo repertorio".
   Las 19 partituras son el mismo archivo, byte a byte, que las de José
   María (ver TRANSCRIPCION_EDUARD_FUENTES.md); su curva de lectura
   (`cancion.CURVA['eduard']`) es también la misma que la suya. Lo único que
   cambia entre los dos cuadernos es el andamio inventado (pitches propios en
   cada `piano1.bloques` y cada `ficha.ritmos`), comprobado por
   `cruzar_eduard.py`.

   Antes de ejecutarlo tiene que salir TODO OK en auditar_eduard.py y, en
   cruzar_eduard.py, que los únicos solapes con José María sean las citas
   literales ya documentadas (la FRASE de America, el compás 12 de Jailhouse
   Rock) — cero solapes de andamio inventado.
"""
import os
import sys
...
ETAPAS = [
    ...
    ('Más tonalidades, y las dos manos de verdad', 'cuando ninguna mano descansa', [
        ...
        dict(num=13, titulo='Adagio', autor='Albinoni · arr. A. L. Christopherson',
             tonalidad='Sin armadura', compas='3/4', trabaja='Las dinámicas: lo difícil aquí es el sonido'),
    ...
    ('Los cuatro retos', 'ninguno trae nada nuevo: traen cantidad', [
        ...
        dict(num=18, titulo='Interstellar', autor='Hans Zimmer',
             tonalidad='Sin armadura', compas='3/4', trabaja='Seis páginas: hacer el mapa antes de tocar'),
...
#
# Mismo reparto que José María: dos semanas por pieza en las quince
# primeras, y TRES en las cuatro últimas.
PLAN = [
    ('Septiembre', [
...
DOSIERES = [
    'Eduard_01_RomanceDiabelli_CUADERNO.pdf',
    'Eduard_02_America_CUADERNO.pdf',
    'Eduard_03_StarSpangledBanner_CUADERNO.pdf',
    'Eduard_04_CountingStars_CUADERNO.pdf',
    'Eduard_05_Peaches_CUADERNO.pdf',
    'Eduard_06_SomeoneYouLoved_CUADERNO.pdf',
    'Eduard_07_DeckTheHalls_CUADERNO.pdf',
    'Eduard_08_JailhouseRock_CUADERNO.pdf',
    'Eduard_09_GrandfathersClock_CUADERNO.pdf',
    'Eduard_10_Shallow_CUADERNO.pdf',
    'Eduard_11_CantHelpFalling_CUADERNO.pdf',
    'Eduard_12_CarolOfTheBells_CUADERNO.pdf',
    'Eduard_13_AdagioAlbinoni_CUADERNO.pdf',
    'Eduard_14_Rasputin_CUADERNO.pdf',
    'Eduard_15_Toreador_CUADERNO.pdf',
    'Eduard_16_Trouble_CUADERNO.pdf',
    'Eduard_17_AcommeAmour_CUADERNO.pdf',
    'Eduard_18_Interstellar_CUADERNO.pdf',
    'Eduard_19_FlyingTheme_CUADERNO.pdf',
]
