            ...
            dict(num=1, titulo='El bajo, que es lo que se oye', clef='bass',
                 ...
                 sistemas=[
                     ...
                     dict(cap='b) y AHORA con su figura de verdad, la semicorchea · el mismo dibujo el doble de rápido, tal y como está impreso en tu partitura',
                          events=[{'pitch': 'E3', 'dur': 's', 'beam': 9110},
                                  {'pitch': 'A2', 'dur': 's', 'beam': 9110},
                                  {'pitch': 'B2', 'dur': 's', 'beam': 9110},
                                  {'pitch': 'G2', 'dur': 's', 'beam': 9110},
                                  {'pitch': 'C3', 'dur': 's', 'beam': 9111},
                                  {'pitch': 'B2', 'dur': 's', 'beam': 9111},
                                  {'pitch': 'An2', 'dur': 's', 'beam': 9111},
                                  {'pitch': 'A2', 'dur': 's', 'beam': 9111},
                                  {'pitch': 'E3', 'dur': 'q'},
                                  {'pitch': 'A2', 'dur': 'q'}],
