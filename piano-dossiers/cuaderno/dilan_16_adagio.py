...
CANCION['piano1']['bloques'] = list(CANCION['piano1']['bloques']) + bloques_extra(
    'Sol menor', 15, 'G3', 'G2',
    'los dos bemoles, antes de que entren los tresillos',
    desde=6, time_sig=(3, 4)) + [
    bloque_tresillos('Sol menor', 5, 'G3', 'los tresillos, que en 3/4 se cuentan igual', time_sig=(3, 4))]
