# -*- coding: utf-8 -*-
"""America (My Country, 'Tis of Thee) — pieza 4 de Eduard. Formato ADULTO.
   ...
   pieza 2 de José María, byte a byte):

     - Do mayor: detrás de la clave no hay nada. Compás de 3/4. Pone
       "With Reverence".
     - La melodía de los cuatro primeros compases, medida cabeza a cabeza
       (heredado de José María, mismo archivo):
     ...
     - La izquierda toca acordes de dos notas y blancas con puntillo.
...
from ed_comun import n, ac, plan, metronomo, diferencias, nombres, escribir, para_clase

HERE = os.path.dirname(__file__)
AZUL = HexColor('#3E6E8F')
OCRE = HexColor('#8C6A3F')

# Los cuatro primeros compases, medidos (heredado del mismo archivo). Cita literal.
...
CANCION = dict(
    ...
    ficha=dict(
        ...
        armonia=dict(
            ...
            tarjetas=[
                ...
                ('EL RITMO', 'Larga y corta',
                 'Los compases pares llevan negra con puntillo y corchea: "LAAA-ar-ga".'),
                ('LA IZQUIERDA', 'Una por compás',
                 'Dos notas a la vez, largas, una vez por compás.'),
            ],
            pie='Toda la melodía se mueve entre el Si y el Fa: siete teclas blancas seguidas y ni '
                'una más. La mano se coloca una vez y ya no hay que buscar nada.',
        ),
        ritmos=[
        ...
        especial=[
            ...
            'Los compases 2 y 4 llevan negra con puntillo y corchea, la figura nueva de esta pieza.',
            'La izquierda toca una sola vez por compás y aguanta los tres golpes.',
            'Al final pone "rit.": ir frenando poco a poco.',
        ],
        ...
        truco='Di la letra en voz alta mientras tocas, sílaba a sílaba: "my COUN-try TIS of THEE".',
        sabias='La melodía es la del himno del Reino Unido, "God Save the King". En 1831 un pastor '
               'de Boston le puso letra nueva en inglés americano.',
                 ...
                 sistemas=[
                     dict(cap='a) las alturas medidas de los cc. 1–4, todas en negras y sin el puntillo',
                          events=[n('C4'), n('C4'), n('D4'),
                                  ...
                                  n('E4'), n('D4'), n('C4')],
                          bars=4),
                     dict(cap='b) y ahora con el ritmo de verdad · di la letra en voz alta',
                          events=FRASE, bars=4, show_time=False),
                 ]),
            dict(tipo='nota',
                 etiqueta='QUÉ ES UNA NEGRA CON PUNTILLO',
                 texto='El puntito de detrás de una nota le añade la mitad de lo que dura. Una '
                       'negra vale un golpe, así que una negra con puntillo vale golpe y medio, y '
                       'la corchea que va detrás ocupa el medio que queda.'),
            dict(num=2, titulo='La izquierda: tocar y aguantar', clef='bass',
                 pista='andamio en Do mayor · otro par de acordes',
                 sistemas=[
                     dict(cap='a) dos notas a la vez, sostenidas el compás entero',
                          events=[ac(('D3', 'F3'), 'h.'), ac(('C3', 'E3'), 'h.'),
                                  ac(('D3', 'F3'), 'h.'), ac(('D3', 'G3'), 'h.')],
                          bars=4, clef='bass'),
                     dict(cap='b) y el mismo ejercicio soltando en el tres',
                          events=[ac(('D3', 'F3'), 'h'), n('D3'),
                                  ac(('C3', 'E3'), 'h'), n('C3'),
                                  ac(('D3', 'F3'), 'h'), n('D3')],
                 ...
                 sistemas=[
                     dict(cap='a) la derecha con su ritmo y la izquierda aguantando debajo',
                          events=[n('C4'), n('C4'), n('D4'),
                                  n('B3', 'q.'), {'pitch': 'C4', 'dur': 'e'}, n('D4')],
                          bars=2),
                     dict(cap='b) esto es lo que hace la izquierda a la vez (andamio)',
                          events=[ac(('D3', 'F3'), 'h.'), ac(('C3', 'E3'), 'h.')],
    ...
    trabajo=[
        dict(
            ...
            intro='Veinte minutos al día. La pieza es corta: lo que hay que trabajar es el ritmo '
                  'con puntillo, no las notas.',
            bloques=[
                ...
                para_clase('La melodía sola, y el compás donde entra la negra con puntillo. Si hay '
                           'un sitio donde siempre te tropiezas, tráelo marcado.'),
            ],
        ),
    ],
)
...
CANCION['piano1']['bloques'] = list(CANCION['piano1']['bloques']) + bloques_extra(
    ...
    bloque_puntillo('Do mayor', 4, 'C4', 'el ritmo con puntillo del principio',
