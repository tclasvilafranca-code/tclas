# -*- coding: utf-8 -*-
"""Jailhouse Rock — pieza 8 de Eduard. Formato ADULTO.

   Lo comprobado sobre el PDF de su carpeta (Elvis Presley, arreglo de Sadie
   King, descarga de Musescore, 1 página, unos 20 compases; el mismo archivo
   que la pieza 8 de José María, byte a byte):
     ...
     - La izquierda hace redondas de dos notas los primeros compases, y en el
       ...
       IMPRESA debajo: 5 · 3 · 2 · 1 — Fa · La · Do · Re (medido, heredado de
       la comprobación hecha para el cuaderno de José María y de Josep, que
       tienen la misma partitura).
