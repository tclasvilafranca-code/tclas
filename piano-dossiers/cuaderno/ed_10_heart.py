    ...
    piano1=dict(
        ...
        bloques=[
            ...
            dict(num=3, titulo='Las dos manos, una vez cada una',
                 pista='cc. 1–2 · la izquierda camina y la derecha se mueve encima',
                 sistemas=[
                     dict(cap='a) primero solo en los cambios: las dos manos a la vez, cuatro veces',
                          events=[ac(('C3', 'C4'), 'h'), ac(('A2', 'C4'), 'h'),
                                  ac(('F2', 'B3'), 'h'), ac(('G2', 'D4'), 'h')],
                          bars=2, manos='dobla'),
                     dict(cap='b) y con la derecha entera por encima de la izquierda quieta',
