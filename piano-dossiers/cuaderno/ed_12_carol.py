# -*- coding: utf-8 -*-
"""Carol of the Bells — pieza 12 de Eduard. Formato ADULTO.

   Lo comprobado sobre el PDF de su carpeta (Mykola Leontovych, arreglo de
   Jim Paterson, mfiles.co.uk, 1 página, 36 compases; el mismo archivo que la
   pieza 12 de José María, byte a byte):
...
from ed_comun import (n, ac, sil, corch, plan, metronomo, diferencias, nombres,
                      escribir, para_clase)
    ...
    ficha=dict(
        ...
        ritmos=[
            ('MANO DERECHA', 'el dibujo que se repite toda la pieza · andamio',
             celula('D5', 'C5', 'D5', 'Bb4'), OCRE, 'treble', SOLM),
            ...
            dict(num=2, titulo='La izquierda, por partes', clef='bass',
                 ...
                 sistemas=[
                     ...
                     dict(cap='b) y más adelante, acordes repetidos · ligeros, que no tapen a la '
                              'derecha',
                          events=[ac(('D2', 'A2')), ac(('D2', 'A2')), ac(('D2', 'A2')),
                                  ac(('Bb2', 'F3')), ac(('Bb2', 'F3')), ac(('Bb2', 'F3'))],
    ...
    trabajo=[
        dict(
            ...
            bloques=[
                ...
                diferencias(
                    celula('D5', 'C5', 'D5', 'Bb4') + celula('D5', 'C5', 'D5', 'Bb4'),
                    celula('D5', 'C5', 'D5', 'B4') + celula('D5', 'C5', 'E5', 'Bb4'),
                    cuantas=2,
                    titulo='Busca las dos diferencias',
                    pista='arriba el dibujo bueno · abajo, con dos cambios'),
                nombres(['D5', 'C5', 'Bb4', 'A4', 'F5', 'G4', 'E4', 'D4'],
