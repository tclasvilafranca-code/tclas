# -*- coding: utf-8 -*-
"""Adagio, de Albinoni — pieza 13 de Eduard. Formato ADULTO.

   OJO CON EL ARCHIVO: en la carpeta este no es un PDF, es un JPEG (736 ×
   1041), el mismo que el de José María, byte a byte. Lo convierte
   `fuente.normalizar` al montar, que es el mismo sitio donde se arreglan los
   PDF que pypdf no sabe copiar.
...
from ed_comun import (n, ac, sil, objetivo, plan, rodear, unir, colorear,
                      acuerdate, para_clase)

HERE = os.path.dirname(__file__)
AZUL = HexColor('#3E6E8F')
OCRE = HexColor('#8C6A3F')
FUENTE = os.path.join(HERE, '..', 'students', 'eduard', 'source', 'ADAGIO.')
    ...
    ficha=dict(
        ...
        ritmos=[
            ('MANO DERECHA', 'notas largas, y hay que sostenerlas · andamio',
             [n('E4', 'h.'), n('D4', 'h.')], OCRE, 'treble', None),
            ('MANO IZQUIERDA', 'negras sueltas, una por golpe · andamio',
             [n('E2'), n('B2'), n('E3')], AZUL, 'bass', None),
        ],
        especial=[
    ...
    trabajo=[
        dict(
            ...
            bloques=[
                ...
                rodear([[n('E4', 'h.')], [n('D4', 'h.')], [n('E4', 'h.')], [n('C4', 'h.')]],
                ...
                colorear([n('E4', 'h.'), n('D4', 'h.'), n('C4'), n('B3'),
                          n('A3'), n('B3', 'h.')],
