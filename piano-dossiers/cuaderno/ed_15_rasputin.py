# -*- coding: utf-8 -*-
"""Rasputin — pieza 15 de Eduard. Formato ADULTO.
...
from ed_comun import (n, ac, sil, corch, plan, verdadero_falso, inventa,
    ...
    ficha=dict(
        ...
        ritmos=[
            ('MANO DERECHA', 'la melodía, que entra sola · andamio',
             [n('F#4'), n('A4'), n('B4'), n('C#5')], OCRE, 'treble', SIM),
            ...
            dict(num=1, titulo='La melodía sola, que es la que arranca',
                 ...
                 sistemas=[
                     dict(cap='a) despacio, comprobando los Fa y los Do',
                          events=[n('F#4'), n('A4'), n('B4'), n('C#5'),
                                  n('B4'), n('A4'), n('F#4'), n('G#4')],
                          bars=2, key_sig=SIM),
                     dict(cap='b) y con el ritmo que tiene, en corcheas · sin acelerar',
                          events=corch(['F#4', 'A4']) + corch(['B4', 'C#5']) +
                                 corch(['B4', 'A4']) + corch(['F#4', 'E4']),
            ...
            dict(num=2, titulo='Contar los compases en los que no tocas', clef='bass',
                 ...
                 sistemas=[
                     ...
                     dict(cap='b) y ahora la izquierda ya entrada · una vez por compás y aguanta',
                          events=[ac(('F#2', 'C#3'), 'w'), ac(('B2', 'F#3'), 'w'),
                                  ac(('D3', 'A3'), 'w'), ac(('C#3', 'G#3'), 'w')],
