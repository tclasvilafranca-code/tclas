...
from ed_comun import (n, ac, sil, objetivo, plan, verdadero_falso, dibujar,
                      contar, para_clase)
    ...
    ficha=dict(
        ...
        ritmos=[
            ('MANO DERECHA', 'la melodía, con el Fa sostenido · andamio',
             [n('D4'), n('E4'), n('F#4'), n('G4')], OCRE, 'treble', SOL),
            ('MANO IZQUIERDA', 'dos notas largas por compás · andamio',
             [ac(('D2', 'A2'), 'h'), ac(('D2', 'A2'), 'h')], AZUL, 'bass', SOL),
        ],
        especial=[
    ...
    piano1=dict(
        ...
        bloques=[
            dict(num=1, titulo='La escala de Sol: dónde está el sostenido',
                 ...
                 sistemas=[
                     dict(cap='a) subiendo desde una octava más abajo · la única tecla negra es la '
                              'penúltima al subir',
                          events=[n('G2'), n('A2'), n('B2'), n('C3'),
                                  n('D3'), n('E3'), n('F#3'), n('G3')],
                          bars=2, key_sig=SOL, clef='bass'),
                     dict(cap='b) y saltando al Fa sostenido desde varios sitios · para el tacto, no '
                              'para la vista',
                          events=[n('D4'), n('F#4'), n('B3'), n('F#4'),
                                  n('C4'), n('F#4'), n('D4'), n('F#4')],
            ...
            dict(num=3, titulo='La izquierda: el péndulo', clef='bass',
                 ...
                 sistemas=[
                     ...
                     dict(cap='b) y cambiando de acorde sin perder el paso · el péndulo no se para '
                          ...
                          events=[ac(('D2', 'A2'), 'h'), ac(('D2', 'A2'), 'h'),
                                  ac(('A2', 'E3'), 'h'), ac(('A2', 'E3'), 'h'),
                                  ac(('D2', 'A2'), 'h'), ac(('D2', 'A2'), 'h')],
    ...
    trabajo=[
        dict(
            ...
            bloques=[
                ...
                contar([n('D4'), n('E4'), n('F#4'), n('G4'), n('F#4'), n('E4'), n('D4'), n('C4')],
                       ['¿Cuántas notas hay en total?', '¿Cuántas van en tecla negra?',
                        '¿Cuál es la nota más aguda?'],
                       titulo='Mira y cuenta',
                       pista='es la melodía del ejercicio 2a de la hoja de al lado'),
