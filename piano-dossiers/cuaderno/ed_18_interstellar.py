# -*- coding: utf-8 -*-
"""Interstellar — pieza 18 de Eduard. Formato ADULTO. RETO.

   Lo comprobado sobre el PDF de su carpeta (Hans Zimmer, Campamento Musical
   Bye Bye Beethoven, 6 páginas; el mismo archivo que la pieza 18 de José
   María, byte a byte):
   ...
   objetivo. Y manda hacer antes el mapa de la pieza con lápiz.
"""
import os
import sys
...
from ed_comun import (n, ac, sil, corch, plan, teclado, inventa, rodear,
...
CANCION = dict(
    ...
    partitura=os.path.join(HERE, '..', 'students', 'eduard', 'source', 'Interstellar _ .pdf'),
    ...
    ficha=dict(
        ...
        ritmos=[
            ('MANO DERECHA', 'el dibujo corto que se repite · andamio',
             [n('D4'), n('F4'), n('A4')], OCRE, 'treble', None),
            ('MANO IZQUIERDA', 'sostiene el compás entero · andamio',
             [n('D3', 'h.')], AZUL, 'bass', None),
        ],
        especial=[
            'Detrás de la clave no hay armadura.',
            ...
            dict(num=2, titulo='La izquierda: sostener tres golpes', clef='bass',
                 ...
                 sistemas=[
                     dict(cap='a) toca en el uno y deja sonar hasta el final del compás',
                          events=[n('D3', 'h.'), n('B2', 'h.'), n('G2', 'h.'), n('A2', 'h.')],
                          bars=4, clef='bass'),
            ...
            dict(num=3, titulo='Las dos manos, cuatro compases',
                 ...
                 sistemas=[
                     ...
                     dict(cap='b) y esto la izquierda a la vez (andamio) · una nota por compás, y '
                          ...
                          events=[n('D3', 'h.'), n('D3', 'h.'), n('B2', 'h.'), n('A2', 'h.')],
    ...
    trabajo=[
        dict(
            ...
            bloques=[
                ...
                rodear([[n('D4'), n('F4'), n('A4')], [n('B3'), n('D4'), n('F4')],
                        [n('D4'), n('F4'), n('A4')], [n('A3'), n('C4'), n('E4')]],
