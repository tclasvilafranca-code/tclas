            ...
            dict(num=1, titulo='La melodía: cuatro notas',
                 ...
                 sistemas=[
                     ...
                     dict(cap='b) y AHORA con su figura de verdad, la semicorchea · el mismo dibujo el doble de rápido, tal y como está impreso en tu partitura',
                          events=[{'pitch': 'F5', 'dur': 's', 'beam': 9170},
                                  {'pitch': 'C5', 'dur': 's', 'beam': 9170},
                                  {'pitch': 'D5', 'dur': 's', 'beam': 9170},
                                  {'pitch': 'C5', 'dur': 's', 'beam': 9170},
                                  {'pitch': 'F5', 'dur': 's', 'beam': 9171},
                                  {'pitch': 'F5', 'dur': 's', 'beam': 9171},
                                  {'pitch': 'G5', 'dur': 's', 'beam': 9171},
                                  {'pitch': 'E5', 'dur': 's', 'beam': 9171},
                                  {'pitch': 'F5', 'dur': 'q'},
                                  {'pitch': 'C5', 'dur': 'q'}],
