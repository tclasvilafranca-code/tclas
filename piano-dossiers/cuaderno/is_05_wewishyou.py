# -*- coding: utf-8 -*-
"""We Wish You a Merry Christmas — pieza 5 de Isaac.
   ...
   el mismo archivo que la pieza 10 de Mercè, byte a byte):
...
CANCION = dict(
    alumno='Isaac', carpeta='Isaac', num=5, nivel='intermedio', slug='WeWishYou',
    formato='adulto',
    titulo_corto='We Wish You a Merry Christmas', time_sig=(3, 4), key_sig=SOL,
    ...
    ficha=dict(
        ...
        armonia=dict(
            ...
            tarjetas=[
                ...
                ('UN SOSTENIDO FIJO', 'Todos los Fa',
                 'Está en la armadura, así que vale para toda la pieza.'),
        ...
        truco='Cuenta "tres" en voz alta antes de tocar la primera nota, como si ya estuvieras a '
              'mitad de compás, y entra justo en el "y" siguiente.',
        sabias='Cantar de puerta en puerta a cambio de comida y bebida era una tradición inglesa '
               'llamada "wassailing", mucho más antigua que la propia canción.',
    ...
    piano1=dict(
        ...
        bloques=[
            dict(num=1, titulo='Entrar con la anacrusa',
                 pista='andamio en Sol mayor · otro dibujo, mismo compás incompleto',
                 sistemas=[
                     dict(cap='a) dos tiempos callados y entras en el tercero, bajando',
            ...
            dict(num=2, titulo='La izquierda: los acordes de las letras',
                 ...
                 sistemas=[
                     dict(cap='a) D y G, sostenidos el compás entero',
                          events=[ac(('D3', 'F#3'), 'h.'), ac(('G2', 'B2'), 'h.')],
                          bars=2, clef='bass'),
                     dict(cap='b) C y A7, con el sostenido de la armadura',
                          events=[ac(('C3', 'E3'), 'h.'), ac(('A2', 'C#3'), 'h.')],
            ...
            dict(tipo='nota',
                 ...
                 texto='Una letra como "G" no es un adorno: te dice que en ese compás la izquierda '
                       ...
                       'saber el nombre del acorde ayuda a anticipar el sonido antes de tocarlo.'),
            dict(num=3, titulo='Las dos juntas',
                 ...
                 sistemas=[
                     dict(cap='a) la melodía entra sola y la izquierda se une después',
                          events=[sil('h'), n('B4'), ac(('D3', 'F#3')), n('A4'), n('G4'),
                                  ac(('G2', 'B2', 'F#4'), 'h.')],
                          bars=3),
                     dict(cap='b) y con el cambio a C y A7',
                          events=[sil('h'), n('D4'), ac(('C3', 'E3')), n('B3'), n('A3'),
                                  ac(('A2', 'C#3', 'C4'), 'h.')],
                          bars=3, show_time=False),
                 ]),
        ] + bloques_extra('Sol mayor', 14, 'G3', 'G2',
