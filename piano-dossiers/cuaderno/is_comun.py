# -*- coding: utf-8 -*-
"""Piezas sueltas de las hojas de Isaac.

   Isaac es de nivel medio, y el cliente pidio darle caña: su curva vive en
   `cancion.CURVA['isaac']`, mas rapida que la de Jose Maria o Merce pero sin
   llegar al techo de los avanzados (Nel, Dilan, Eva, Josep).

   Formato adulto estandar, igual que Jose Maria, Merce y Nel: sin los
