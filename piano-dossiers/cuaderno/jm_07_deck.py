# -*- coding: utf-8 -*-
"""Deck the Halls — pieza 7 de José María. Formato ADULTO.

   Lo comprobado sobre el PDF de su carpeta de Drive (mfiles.co.uk, arreglo de
   Jim Paterson, 1 página, 16 compases con repetición):
   ...
   Lo que NO se cita nota a nota: las dos manos llevan acordes y la medición
   se ensucia. El material va como ANDAMIO en Fa mayor y remite a la
   partitura.
"""
import os
import sys
...
CANCION = dict(
    alumno='José María', carpeta='JoseMaria', num=7, nivel='iniciación',
    ...
    ficha=dict(
        ...
        ritmos=[
            ('MANO DERECHA', 'dos notas a la vez, y con puntillo · andamio',
             [ac(('A4', 'F5'), 'q.'), {'pitch': 'G4', 'dur': 'e'}, ac(('F4', 'A4')), n('F4')],
             OCRE, 'treble', FA),
            ('MANO IZQUIERDA', 'también dos, y más largas · andamio',
             [ac(('F2', 'C3'), 'h'), n('A2'), n('C3')], AZUL, 'bass', FA),
        ],
        especial=[
            ...
            dict(num=3, titulo='El compás con puntillo del principio',
                 ...
                 sistemas=[
                     dict(cap='a) larga y corta: "LAAA-la" · cuenta "UN dos-y TRES cuatro"',
                          events=[ac(('A4', 'F5'), 'q.'), {'pitch': 'G4', 'dur': 'e'},
                                  ac(('F4', 'A4')), n('F4'),
                                  ac(('E4', 'G4'), 'q.'), {'pitch': 'F4', 'dur': 'e'},
                                  ac(('E4', 'G4')), n('C4')],
                          bars=2, key_sig=FA),
                     dict(cap='b) y sin el puntillo, todo en negras · asi se ve que las notas son las '
                          ...
                          events=[ac(('A4', 'F5')), n('G4'), ac(('F4', 'A4')), n('F4'),
                                  ac(('E4', 'G4')), n('F4'), ac(('E4', 'G4')), n('C4')],
                          bars=2, key_sig=FA, show_time=False),
                 ]),
        ],
    ),
    ...
    trabajo=[
        dict(
            ...
            bloques=[
                ...
                diferencias(
                    [n('F4'), n('G4'), n('A4'), n('Bb4'), n('A4'), n('G4')],
                    [n('F4'), n('G4'), n('A4'), n('B4'), n('A4'), n('F4')],
                    cuantas=2,
