            ...
            dict(num=2, titulo='El tresillo, contado',
                 ...
                 sistemas=[
                     dict(cap='a) TRES notas donde normalmente caben dos · di "u-ni-dad" en cada '
                          ...
                          events=[dict(n('A4', 'e'), tresillo=1, beam=901),
                                  dict(n('G4', 'e'), tresillo=1, beam=901),
                                  dict(n('F4', 'e'), tresillo=1, beam=901),
                                  dict(n('G4', 'e'), tresillo=2, beam=902),
                                  dict(n('A4', 'e'), tresillo=2, beam=902),
                                  dict(n('B4', 'e'), tresillo=2, beam=902),
                                  dict(n('A4', 'e'), tresillo=3, beam=903),
                                  dict(n('G4', 'e'), tresillo=3, beam=903),
                                  dict(n('F4', 'e'), tresillo=3, beam=903)],
                          bars=1),
                 ]),
