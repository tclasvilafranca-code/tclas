# -*- coding: utf-8 -*-
"""Trouble — pieza 16 de José María. Formato ADULTO. PRIMERA DE LOS RETOS.

   Lo comprobado sobre el PDF de su carpeta de Drive (Coldplay, arreglo de
   Unai Karam, 4 páginas):
...
CANCION = dict(
    alumno='José María', carpeta='JoseMaria', num=16, nivel='iniciación',
    ...
    ficha=dict(
        ...
        ritmos=[
            ('MANO DERECHA', 'la melodía, en corcheas · andamio',
             corch(['D5', 'B4']) + corch(['A4', 'G4']) + corch(['A4', 'B4']) +
             corch(['D5', 'G4']), OCRE, 'treble', SOL),
            ('MANO IZQUIERDA', 'notas largas, una o dos por compás · andamio',
             [ac(('G2', 'D3'), 'h'), ac(('E2', 'B2'), 'h')], AZUL, 'bass', SOL),
        ],
        especial=[
            ...
            dict(num=1, titulo='La melodía de la primera página',
                 ...
                 sistemas=[
                     dict(cap='a) primero en negras, la mitad de rápido y con las mismas notas',
                          events=[n('B4'), n('A4'), n('G4'), n('A4'),
                                  n('B4'), n('D5'), n('B4'), n('G4')],
                          bars=2, key_sig=SOL),
                     dict(cap='b) y ahora en corcheas · si te cansas antes de acabar el compás, ve más '
                              'lento',
                          events=corch(['B4', 'A4']) + corch(['G4', 'A4']) +
                                 corch(['B4', 'D5']) + corch(['B4', 'G4']),
