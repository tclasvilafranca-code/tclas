    ...
    piano1=dict(
        ...
        bloques=[
            ...
            dict(num=3, titulo='Las dos manos, cuatro compases',
                 pista='andamio · escribe tú los dedos antes de tocar, y cuenta en voz alta',
                 sistemas=[
                     ...
                     dict(cap='b) y ahora con el cambio de dedo metido dentro · el Sol se repite '
                          ...
                          events=[ac(('F2', 'G4')), dict(pitch='G4', dur='q'),
                                  dict(pitch='A4', dur='q'), n('F4'),
