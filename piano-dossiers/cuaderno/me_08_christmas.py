...
CANCION = dict(
    ...
    piano1=dict(
        ...
        bloques=[
            dict(num=1, titulo='La izquierda: dos blancas por compás', clef='bass',
                 pista='andamio en Do mayor · la forma es la de tu partitura, ya en clave de fa',
                 sistemas=[
        ...
        ] + bloques_extra('Do mayor', 37, 'C4', 'C3',
                          'a cuatro manos hay que entrar donde toca, no cuando estés listo',
