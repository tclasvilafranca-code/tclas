# -*- coding: utf-8 -*-
"""I Have a Dream, de Abba — pieza 20 de Mercè.
   ...
   pieza 6 de Luisa, byte a byte), leído a 230 dpi:
...
CANCION = dict(
    alumno='Mercè', carpeta='Merce', num=20, nivel='intermedio', slug='IHaveADream',
    formato='adulto',
    titulo_corto='I Have a Dream', time_sig=(4, 4), key_sig=None,
    partitura=os.path.join(HERE, '..', 'students', 'merce', 'source', 'i-have-a-dream-abba-.pdf'),
    ...
    ficha=dict(
        ...
        datos=[('Tonalidad', 'Do mayor'), ('Compás', '4/4'),
               ...
               ('Derecha', 'Puntillo')],
        titulo_ritmos='El primer puntillo de tu cuaderno',
        ...
        armonia=dict(
            ...
            tarjetas=[
                ('EL PRIMER PUNTILLO', 'Larga y corta',
                 'Es la primera vez en tu cuaderno que aparece este dibujo: una nota que dura tiempo '
                 'y medio, seguida de una corta que completa el tiempo que falta.'),
        ...
        especial=[
            ...
            'La derecha combina negra con puntillo y corchea: el primer puntillo del álbum.',
            'La izquierda hace redondas, con alguna blanca.',
            'El dibujo de puntillo se repite varias veces a lo largo de la melodía.',
        ],
        reto='Que la corchea del puntillo no se alargue ni se acorte. La negra con puntillo dura '
             'tiempo y medio exacto, ni un pelo más.',
        truco='Cuenta en corcheas todo el compás ("un-y, dos-y, tres-y, cuatro-y") y toca la nota '
              'larga en "un" sosteniéndola hasta "dos", y la corta justo en el "y" del dos. Repite '
              'hasta que la proporción salga siempre igual.',
        sabias='ABBA la publicó en 1979 y, aunque no fue el single más vendido del grupo, se ha '
               'convertido en una de sus canciones más versionadas, incluida una famosa grabación '
               'de Westlife casi veinte años después.',
        qr=dict(titulo='Escúchala',
                texto='Sigue la letra mientras escuchas y marca con el dedo dónde cae cada sílaba '
                      'larga y cada sílaba corta: ese patrón es el puntillo.'),
    ),
    ...
    piano1=dict(
        ...
        bloques=[
            dict(num=1, titulo='El puntillo, aislado y contado',
                 ...
                 sistemas=[
                     dict(cap='a) larga, corta, larga, corta: el dibujo de la pieza',
            ...
            dict(num=2, titulo='La izquierda: redondas que sostienen',
                 ...
                 sistemas=[
                     dict(cap='a) toca en el uno y aguanta el compás entero',
            ...
            dict(tipo='nota',
                 ...
                 texto='Un puntillo añade la mitad del valor de la nota: una negra con puntillo dura '
                       ...
                       'adivinarlo. Contar solo en negras, en cambio, hace que la corchea se toque '
                       'siempre tarde o siempre pronto.'),
            dict(num=3, titulo='Las dos juntas',
                 pista='andamio · la izquierda no se mueve mientras la derecha marca el puntillo',
                 sistemas=[
                     dict(cap='a) la redonda sostiene bajo el dibujo de puntillo',
        ...
        ] + bloques_extra('Do mayor', 10, 'C5', 'C3',
