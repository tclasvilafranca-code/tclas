# -*- coding: utf-8 -*-
"""Piezas sueltas de las hojas de Mercè.

   Mercè no tiene un nivel alto, pero bastante más que Luisa, y su clase de
   hora y media es la más larga del proyecto. El esquema del dosier es el
   mismo que el de todos los adultos —partitura, ficha, calentamiento,
   agudeza visual, cómo se estudia, relajación con el recuadro de la
   profesora, y papel pautado—, y lo único que cambia es el nivel: eso vive en
   `cancion.CURVA['mercè']`, no aquí.
