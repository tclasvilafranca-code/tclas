...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'DILAN', 'bohemian-rhapsody_.pdf')
OUT_DIR = os.path.join(HERE, '..', '..', '..', 'output')

song23 = dict(
  num=23, title='Bohemian Rhapsody', subtitle='Queen · Freddie Mercury (1975)',
  ...
  la_cancion='La apertura de piano de una de las canciones más famosas de la historia, en Sib mayor. Es la pieza con más acordes distintos del año.',
  difficult_cc='cc. 1–8', difficult_title='Leer con fluidez muchos acordes',
  reto='reconocer cada acorde nuevo (incluidos los de séptima) sin pararte a pensarlo letra a letra.',
  truco='antes de tocar, lee todo el cifrado de la partitura en voz alta, de acorde en acorde, como si leyeras una frase.',
  ...
  ritmo_texto='Ritmo: compás de 4/4, moderato — los acordes cambian con frecuencia, así que anticipa cada cambio.',
  estudiar_steps=['Busca SIB y tócala 3 veces (tu nota casa).',
                   'Lee en voz alta el nombre de cada acorde, de principio a fin, antes de tocar.',
                   'Los seis acordes con la izquierda, uno a uno, sin prisa.',
                   'Las dos manos juntas, todo el fragmento, con calma.'],
  checklist_items=['Encuentro SIB y pongo bien los dedos.', 'Reconozco los acordes con séptima (Do7).',
                    'Sé los seis acordes de la canción de memoria.', 'Junto las dos manos en todo el fragmento.'],
  nivel_kicker='DILAN · NIVEL MEDIO-ALTO · JUNIO',
  total_songs=24,
)

cfg23 = dict(
  kicker='DILAN · JUNIO · BOHEMIAN RHAPSODY',
  ...
  chords_desc='Identifica cada acorde: nómbralo (Sib, Do7, Fa, Solm...) y di si es mayor, menor o con séptima.',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Dilan_23_Bohemian_Rhapsody.pdf')
