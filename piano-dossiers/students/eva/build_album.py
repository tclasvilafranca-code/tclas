"""Construye el cuaderno completo de Eva: portada + los dosieres de cada
...
SONGS = [
    ...
    ('09_writings_on_the_wall', 'Eva_09_Writings_On_The_Wall.pdf',
     dict(num=9, title="Writing's on the Wall", subtitle='Sam Smith · James Bond',
          tonalidad='Fa mayor', dificultad=2)),
    ('10_arabesque', 'Eva_10_Arabesque.pdf',
     dict(num=10, title='Arabesque', subtitle='Burgmüller · a 4 manos',
          tonalidad='Do mayor', dificultad=3)),
    ('11_despacito', 'Eva_11_Despacito.pdf',
     dict(num=11, title='Despacito', subtitle='Luis Fonsi & Daddy Yankee',
          tonalidad='La menor', dificultad=2)),
    ('12_when_i_was_your_man', 'Eva_12_When_I_Was_Your_Man.pdf',
     dict(num=12, title='When I Was Your Man', subtitle='Bruno Mars',
          tonalidad='Do mayor', dificultad=2)),
    ('13_schindlers_list', 'Eva_13_Schindlers_List.pdf',
     dict(num=13, title="Theme from Schindler's List", subtitle='John Williams',
          tonalidad='Sol menor', dificultad=3)),
    ('14_amiga_mia', 'Eva_14_Amiga_Mia.pdf',
     dict(num=14, title='Amiga Mía', subtitle='Alejandro Sanz',
          tonalidad='Re mayor', dificultad=2)),
    ('15_la_promesa', 'Eva_15_La_Promesa.pdf',
     dict(num=15, title='La Promesa', subtitle='Melendi',
          tonalidad='Sol mayor', dificultad=2)),
    ('16_lucia', 'Eva_16_Lucia.pdf',
     dict(num=16, title='Lucía', subtitle='Joan Manuel Serrat',
          tonalidad='La menor', dificultad=3)),
    ('17_poema_de_amor', 'Eva_17_Poema_De_Amor.pdf',
     dict(num=17, title='Poema de Amor', subtitle='Joan Manuel Serrat',
          tonalidad='Sol menor', dificultad=3)),
    ('18_when_we_were_young', 'Eva_18_When_We_Were_Young.pdf',
     dict(num=18, title='When We Were Young', subtitle='Adele',
          tonalidad='Re menor', dificultad=3)),
    ('19_thinking_out_loud', 'Eva_19_Thinking_Out_Loud.pdf',
     dict(num=19, title='Thinking Out Loud', subtitle='Ed Sheeran',
          tonalidad='Re mayor', dificultad=3)),
    ('20_my_favourite_things', 'Eva_20_My_Favourite_Things.pdf',
     dict(num=20, title='My Favourite Things', subtitle='Sound of Music',
          tonalidad='Mi menor', dificultad=3)),
    ('21_bohemian_rhapsody', 'Eva_21_Bohemian_Rhapsody.pdf',
     dict(num=21, title='Bohemian Rhapsody', subtitle='Queen',
...
MONTHS = [
    ...
    ('Febrero', [SONGS[9][2]]),
    ('Marzo', [SONGS[10][2]]),
    ('Abril', [SONGS[11][2], SONGS[12][2]]),
    ('Mayo', [SONGS[13][2], SONGS[14][2], SONGS[15][2], SONGS[16][2], SONGS[17][2]]),
    ('Junio', [SONGS[18][2], SONGS[19][2], SONGS[20][2]]),
]


def _run_song_build(folder):
    """Imports and runs students/eva/<folder>/build.py's main(), regenerating
...
def main():
    ...
    album_path = os.path.join(OUT_DIR, 'Eva_Cuaderno_del_Pianista.pdf')
