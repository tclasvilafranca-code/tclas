...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'JOSEP', 'cant-help-falling-in-love--elvis-presley_.pdf')
...
cfg1 = dict(
  kicker='JOSEP · SEPTIEMBRE · CAN\'T HELP FALLING IN LOVE',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Josep_01_Cant_Help_Falling_In_Love.pdf')
