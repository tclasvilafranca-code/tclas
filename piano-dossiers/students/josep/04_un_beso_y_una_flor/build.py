...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'JOSEP', ' Un-beso-y-una-flor-nino-bravo_.pdf')
...
cfg4 = dict(
  kicker='JOSEP · OCTUBRE · UN BESO Y UNA FLOR',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Josep_04_Un_Beso_Y_Una_Flor.pdf')
