...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'JOSEP', 'Rasputyn.pdf')
...
song5 = dict(
  ...
  nivel_kicker='JOSEP · NIVEL MEDIO-ALTO · NOVIEMBRE',
  total_songs=22,
)

cfg5 = dict(
  kicker='JOSEP · NOVIEMBRE · RASPUTIN',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Josep_05_Rasputin.pdf')
