...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'JOSEP', 'petite chanson.pdf')
...
song10 = dict(
  ...
  nivel_kicker='JOSEP · NIVEL MEDIO-ALTO · FEBRERO',
  total_songs=22,
)

cfg10 = dict(
  kicker='JOSEP · FEBRERO · PETITE CHANSON',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Josep_10_Petite_Chanson.pdf')
