...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'JOSEP', '- A COMME AMOUR _ Richard Clayderman_.pdf')
...
cfg12 = dict(
  kicker='JOSEP · MARZO · A COMME AMOUR',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Josep_12_A_Comme_Amour.pdf')
