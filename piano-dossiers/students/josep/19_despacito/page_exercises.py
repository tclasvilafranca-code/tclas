# -*- coding: utf-8 -*-
"""Taller de practica - Despacito (Josep, cancion 19, Do mayor, 4/4).
   Mismo arreglo que el de Dilan (ostinato sincopado 3+3+2) y el de
   Eva (contraste verso-estribillo), pero enfoque DISTINTO para
   Josep: el ORNAMENTO -- un pasaje rapido de corcheas que decora la
...
SONG_KICKER = 'JOSEP · MAYO · DESPACITO (LUIS FONSI & DADDY YANKEE)'
TS = (4, 4)
