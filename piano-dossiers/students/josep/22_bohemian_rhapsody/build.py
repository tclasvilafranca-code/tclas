...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'JOSEP', 'Bohemian Rhapsody.pdf')
...
cfg22 = dict(
  kicker='JOSEP · JUNIO · BOHEMIAN RHAPSODY',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Josep_22_Bohemian_Rhapsody.pdf')
