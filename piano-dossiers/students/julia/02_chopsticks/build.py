...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'JULIA', ' Chopsticks.pdf')
OUT_DIR = os.path.join(HERE, '..', '..', '..', 'output')

song2 = dict(
  num=2, title='Chopsticks', subtitle='Level One · arr. Gilbert DeBenedetti',
  tonalidad='Do mayor', compas='3/4', tempo='Alegre, con juego', forma='Estrofa',
  dificultad='Nivel inicial', manos='Manos alternas + acordes',
  la_cancion='Un juego de piano muy famoso en todo el mundo, en Do mayor. Hoy practicamos que las dos manos se turnen sin chocar, como si se pasaran una pelota.',
  ...
  sabias_que='"Chopsticks" (1877) fue compuesta por una adolescente británica de 16 años, Euphemia Allen, bajo el seudónimo "Arthur de Lulli".',
...
cfg2 = dict(
  kicker='JULIA · SEPTIEMBRE · CHOPSTICKS',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Julia_02_Chopsticks.pdf')
