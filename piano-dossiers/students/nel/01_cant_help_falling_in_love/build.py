...
song1 = dict(
  ...
  dificultad='Un reto de voicing', manos='Acordes con voz destacada',
  la_cancion='Un vals lento en Re mayor. Aquí el reto es de verdadero pianista: dentro de un mismo acorde de la mano derecha, hacer que la nota más aguda cante claramente por encima de las demás.',
  difficult_cc='cc. 1–8', difficult_title='El voicing: una nota que canta sobre las demás',
  reto='tocar un acorde entero con una sola mano pero conseguir que solo la nota de arriba se oiga como melodía.',
  truco='ensaya el acorde tocando primero solo la nota de arriba fuerte, luego añade las demás muy flojitas debajo, sin cambiar el equilibrio.',
  ...
  ritmo_texto='Ritmo: compás de 3/4 — cada acorde de la derecha con la nota de arriba siempre destacada.',
  estudiar_steps=['Busca RE y tócala 3 veces (tu nota casa).',
                   'Cada intervalo o acorde: primero solo la nota de arriba, fuerte.',
                   'Añade las notas de abajo, mucho más flojitas.',
                   'Las dos manos juntas, sin que el voicing se pierda.'],
  checklist_items=['Encuentro RE y pongo bien los dedos.', 'Sé aislar la nota de arriba de un acorde.',
                    'El voicing no se pierde cuando toco las tres notas juntas.', 'Las dos manos juntas mantienen el equilibrio.'],
  nivel_kicker='NEL · NIVEL AVANZADO · SEPTIEMBRE',
  total_songs=22,
)
...
cfg1 = dict(
  ...
  progression=['Re', 'La', 'Sol', 'La'],
  progression_mode='roman',
  rhythm_desc='Lee y marca el ritmo real de la melodía: negras y una nota larga, en 3/4.',
  rhythm_events=[{'pitch': 'F#4', 'dur': 'q'}, {'pitch': 'F#4', 'dur': 'q'}, {'pitch': 'F#4', 'dur': 'q'},
                 {'pitch': 'F#4', 'dur': 'h.'}] * 2,
  rhythm_time_sig=(3, 4),
)
