...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'NEL', 'counting-stars-easy-piano-solo.pdf')
...
cfg2 = dict(
  kicker='NEL · SEPTIEMBRE · COUNTING STARS',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Nel_02_Counting_Stars.pdf')
