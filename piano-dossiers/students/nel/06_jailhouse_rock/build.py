...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'NEL', 'jailhouse-rock-elvis-presley-.pdf')
...
cfg6 = dict(
  kicker='NEL · DICIEMBRE · JAILHOUSE ROCK',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Nel_06_Jailhouse_Rock.pdf')
