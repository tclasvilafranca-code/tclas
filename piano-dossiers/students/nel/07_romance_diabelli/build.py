...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'NEL', '4 MANOS_diabelli-anton-romance-166580.pdf')
...
song7 = dict(
  ...
  nivel_kicker='NEL · NIVEL MEDIO-ALTO · DICIEMBRE',
  total_songs=22,
)

cfg7 = dict(
  kicker='NEL · DICIEMBRE · ROMANCE (DIABELLI)',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Nel_07_Romance_Diabelli.pdf')
