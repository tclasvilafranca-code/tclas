...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'NEL', 'bella-ciao-piano-four-hands-easy-version.pdf')
...
cfg8 = dict(
  kicker='NEL · DICIEMBRE · BELLA CIAO',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Nel_08_Bella_Ciao.pdf')
