...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'NEL', 'what-was-i-made-for-billie-eilish-easy-piano.pdf')
...
song9 = dict(
  ...
  nivel_kicker='NEL · NIVEL MEDIO-ALTO · ENERO',
  total_songs=22,
)

cfg9 = dict(
  kicker='NEL · ENERO · WHAT WAS I MADE FOR?',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Nel_09_What_Was_I_Made_For.pdf')
