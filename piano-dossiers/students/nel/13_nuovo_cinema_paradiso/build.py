...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'NEL', '-NuovoCinemaParadiso.pdf')
...
cfg13 = dict(
  kicker='NEL · ABRIL · NUOVO CINEMA PARADISO',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Nel_13_Nuovo_Cinema_Paradiso.pdf')
