...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'NEL', 'Si-tu-no-estas-aqui-rosana_.pdf')
...
song14 = dict(
  ...
  nivel_kicker='NEL · NIVEL MEDIO-ALTO · ABRIL',
  total_songs=22,
)

cfg14 = dict(
  kicker='NEL · ABRIL · SI TÚ NO ESTÁS AQUÍ',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Nel_14_Si_Tu_No_Estas_Aqui.pdf')
