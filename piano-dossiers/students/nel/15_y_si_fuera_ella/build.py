...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'NEL', 'Y-si-fuera-ella-alejandro-sanz.pdf')
...
cfg15 = dict(
  kicker='NEL · ABRIL · Y SI FUERA ELLA',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Nel_15_Y_Si_Fuera_Ella.pdf')
