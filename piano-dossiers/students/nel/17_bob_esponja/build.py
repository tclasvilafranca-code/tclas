...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'NEL', 'bob-esponja-cancion-inicial-.pdf')
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Nel_17_Bob_Esponja.pdf')
