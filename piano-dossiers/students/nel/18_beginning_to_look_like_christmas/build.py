...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'NEL', 'its-beginning-to-look-a-lot-like-christmas-piano-duet.pdf')
...
cfg18 = dict(
  kicker='NEL · MAYO · IT’S BEGINNING TO LOOK A LOT LIKE CHRISTMAS',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Nel_18_Beginning_To_Look_Like_Christmas.pdf')
