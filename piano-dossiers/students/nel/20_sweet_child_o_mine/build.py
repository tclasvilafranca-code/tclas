...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'NEL', 'sweet-child-o-mine-guns-n-roses-easy-piano.pdf')
...
cfg20 = dict(
  kicker='NEL · JUNIO · SWEET CHILD O’ MINE',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Nel_20_Sweet_Child_O_Mine.pdf')
