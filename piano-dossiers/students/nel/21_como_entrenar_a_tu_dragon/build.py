...
SOURCE_PDF = os.path.join(HERE, '..', 'source', 'NEL', 'Como entrenar a tu dragon.pdf')
...
cfg21 = dict(
  kicker='NEL · JUNIO · CÓMO ENTRENAR A TU DRAGÓN',
...
def main():
    ...
    out_path = os.path.join(OUT_DIR, 'Nel_21_Como_Entrenar_A_Tu_Dragon.pdf')
