...
def _run_song_build(folder):
    """Importa y ejecuta students/nel/<folder>/build.py's main(), regenerando
...
def main():
    ...
    album_path = os.path.join(OUT_DIR, 'Nel_Cuaderno_del_Pianista.pdf')
